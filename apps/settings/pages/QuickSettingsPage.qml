        ...
        Column {
            ...
            MSection {
                ...
                Column {
                    ...
                    Repeater {
                        model: [
                            { id: "wifi", label: "Wi-Fi", icon: "wifi", desc: "Toggle wireless network" },
                            { id: "bluetooth", label: "Bluetooth", icon: "bluetooth", desc: "Connect to devices" },
                            { id: "flight", label: "Flight Mode", icon: "plane", desc: "Disable all radios" },
                            { id: "cellular", label: "Mobile Network", icon: "signal", desc: "Toggle cellular data" },
                            { id: "rotation", label: "Rotation Lock", icon: "rotate-ccw", desc: "Lock screen orientation" },
                            { id: "autobrightness", label: "Auto-brightness", icon: "sun-moon", desc: "Automatic brightness adjustment" },
                            { id: "location", label: "Location", icon: "map-pin", desc: "GPS and location services" },
                            { id: "hotspot", label: "Hotspot", icon: "wifi-tethering", desc: "Share internet connection" },
                            { id: "vibration", label: "Vibration", icon: "vibrate", desc: "Haptic feedback" },
                            { id: "nightlight", label: "Night Light", icon: "moon", desc: "Reduce blue light" },
                            { id: "torch", label: "Torch", icon: "flashlight", desc: "Toggle flashlight" },
                            { id: "notifications", label: "DND Mode", icon: "bell", desc: "Do Not Disturb" },
            ...
            MSection {
                ...
                MSettingsListItem {
                    ...
                    showChevron: false
                    onSettingClicked: {
                        var defaultTiles = ["wifi", "bluetooth", "flight", "cellular", "rotation", "autobrightness", 
