        ...
        VideoOutput {
            ...
            Rectangle {
                ...
                SequentialAnimation {
                    ...
                    NumberAnimation { target: focusRing; property: "scale"; from: 1.5; to: 1.0; duration: 200; easing.type: Easing.OutQuad }
                    PauseAnimation { duration: 500 }
                    NumberAnimation { target: focusRing; property: "opacity"; from: 1.0; to: 0.0; duration: 200 }
                    ScriptAction { script: { focusRing.visible = false; focusRing.opacity = 1.0 } }
                }
            }
        }
