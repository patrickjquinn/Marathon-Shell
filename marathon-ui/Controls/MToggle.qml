...
Item {
    ...
    Accessible.onToggleAction: if (!disabled) toggle()
    ...
    Rectangle {
        ...
        Behavior on border.color {
            ColorAnimation { duration: MMotion.md }
        }
        ...
        Rectangle {
            ...
            gradient: Gradient {
                GradientStop { position: 0.0; color: Qt.rgba(0, 191/255, 165/255, 0.15) }
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            gradient: Gradient {
                ...
                GradientStop { position: 1.0; color: Qt.rgba(0.92, 0.92, 0.92, 1.0) }
            }
