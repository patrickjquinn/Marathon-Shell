...
public:
    ...
    Q_INVOKABLE void setPermission(const QString &appId, const QString &permission, bool granted, bool remember = true);
    ...
    Q_INVOKABLE PermissionStatus getPermissionStatus(const QString &appId, const QString &permission);
    ...
    // Properties
    bool promptActive() const { return m_promptActive; }
    QString currentAppId() const { return m_currentAppId; }
    QString currentPermission() const { return m_currentPermission; }
