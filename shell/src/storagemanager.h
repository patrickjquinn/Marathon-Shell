...
public:
    ...
    qint64 totalSpace() const { return m_totalSpace; }
    qint64 availableSpace() const { return m_availableSpace; }
    qint64 usedSpace() const { return m_usedSpace; }
    double usedPercentage() const { return m_usedPercentage; }
