...
class MarathonSystemService : public QObject, protected QDBusContext
{
    ...
    Q_PROPERTY(bool DisplayAutoRotate READ displayAutoRotate WRITE setDisplayAutoRotate NOTIFY displayAutoRotateChanged)
    Q_PROPERTY(int DisplayOrientation READ displayOrientation NOTIFY DisplayOrientationChanged)

public:
    explicit MarathonSystemService(PowerManagerCpp *power,
