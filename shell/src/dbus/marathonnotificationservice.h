...
public slots:
    uint Notify(const QString &appId, const QString &title, const QString &body, const QVariantMap &options);
...
signals:
    void NotificationReceived(uint id, const QString &appId, const QString &title, const QString &body);
