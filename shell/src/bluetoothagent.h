...
signals:
    ...
    void pairingPasskeyDisplay(const QString &devicePath, const QString &deviceName, quint32 passkey);
    void pairingConfirmationRequested(const QString &devicePath, const QString &deviceName, quint32 passkey);
