...
/**
 * C++ replacement for `shell/qml/services/AppLifecycleManager.qml`.
 *
 * Owns app registry/state in C++ and calls into registered QML app instances
 * (MApp / NativeAppWindow) for lifecycle transitions.
 */
