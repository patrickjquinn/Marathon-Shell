...
EmojiPredictor::EmojiPredictor(QObject *parent)
    ...
    m_emojiMap.insert("love", {"", "", ""});
    m_emojiMap.insert("heart", {"", "", ""});
    ...
    m_emojiMap.insert("thanks", {"", "", ""});
    m_emojiMap.insert("thank", {"", "", ""});
    ...
    m_emojiMap.insert("sun", {"", "", ""});
    m_emojiMap.insert("rain", {"", "", ""});
    m_emojiMap.insert("snow", {"", "", ""});
    m_emojiMap.insert("hot", {"", "", ""});
    m_emojiMap.insert("cold", {"", "", ""});
    m_emojiMap.insert("music", {"", "", ""});
    m_emojiMap.insert("phone", {"", "", ""});
    m_emojiMap.insert("home", {"", "", ""});
    m_emojiMap.insert("work", {"", "", ""});
    m_emojiMap.insert("sleep", {"", "", ""});
    ...
    m_emojiMap.insert("check", {"", "", ""});
    m_emojiMap.insert("question", {"", "", ""});
    m_emojiMap.insert("warning", {"", "", ""});
    ...
    m_emojiMap.insert("run", {"", "‍", "‍"});
    m_emojiMap.insert("walk", {"", "‍", "‍"});
    m_emojiMap.insert("car", {"", "", ""});
    m_emojiMap.insert("plane", {"", "", ""});
    m_emojiMap.insert("dog", {"", "", ""});
    m_emojiMap.insert("cat", {"", "", ""});
    m_emojiMap.insert("book", {"", "", ""});
    m_emojiMap.insert("movie", {"", "", ""});
    m_emojiMap.insert("game", {"", "", ""});
