...
public:
    ...
    bool available() const { return m_hasModemManager; }
    bool modemAvailable() const { return m_modemAvailable; }
    bool modemEnabled() const { return m_modemEnabled; }
    ...
    bool simPresent() const { return m_simPresent; }
    bool dataEnabled() const { return m_dataEnabled; }
    bool dataConnected() const { return m_dataConnected; }
