            ...
            Column {
                ...
                Icon {
                    name: {
                        ...
                        if (iconPath === "phone") return "phone"
                        if (iconPath === "messages") return "message-square"
                        if (iconPath === "browser") return "globe"
                        if (iconPath === "camera") return "camera"
                        if (iconPath === "gallery" || iconPath === "photos") return "image"
                        if (iconPath === "music") return "music"
                        if (iconPath === "calendar") return "calendar"
                        if (iconPath === "clock") return "clock"
                        if (iconPath === "maps") return "map"
                        if (iconPath === "calculator") return "calculator"
                        if (iconPath === "notes") return "file-text"
                        if (iconPath === "files") return "folder"
                        if (iconPath === "email") return "mail"
                        if (iconPath === "settings") return "settings"
