...
Item {
    ...
    property real searchPullProgress: 0 // Exposed to Shell for search overlay
    ...
    ListView {
        ...
        interactive: true
        pressDelay: 200 // Increased from 100 to give nested scrollables time to claim gestures
        // PHYSICS TUNING for smooth, snappy flick (EASIER swiping)
        flickDeceleration: 3000
        // Reduced from 5000 for smoother coasting and less aggressive stealing
        maximumFlickVelocity: 10000
        // Higher velocity = more responsive to lighter flicks
